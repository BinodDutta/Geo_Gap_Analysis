...
def get_marker_properties(z_score):
    ...
    elif z_score >= 2.0: return 3.0, 0.7, '#ff6600', "Moderately Served"
    elif z_score >= 1.0: return 2.0, 0.6, '#ffff00', "Adequately Served"
    else:                return 1.0, 0.4, '#00ffff', "Well Served"
